    ...
    <PageLayout>
      ...
      <section className="mx-auto w-full max-w-6xl px-6 pb-20 pt-12 md:pt-16">
        ...
        <div className="mt-10 grid gap-8 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,0.7fr)]">
          ...
          <div className="rounded-2xl border border-slate-200 bg-gradient-to-br from-white via-white to-blue-50/60 p-6 shadow-sm">
            <div className="flex flex-wrap items-start justify-between gap-4">
              <div>
                <p className="text-[11px] font-semibold uppercase tracking-[0.2em] text-blue-500">
                  Invoice
                </p>
                <h2 className="mt-2 font-['Sora'] text-lg font-semibold text-slate-900">
                  Invoice Pembayaran
                </h2>
